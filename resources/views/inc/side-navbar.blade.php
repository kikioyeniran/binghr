...
{{-- <div class="col-md-3 col-lg-2 d-md-block"> --}}
    {{-- <nav id="outer-sidebar" class="bg-light outer-sidebar collapse">
    ...
    <nav id="sidebar" class="col-md-1 col-lg-1 d-md-block inner-sidebar collapse">
        <div class="position-sticky">
            <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link outer-link active" aria-current="page" href="#">
                ...
                <li class="nav-item">
                  <a class="nav-link outer-link" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-calendar2" viewBox="0 0 16 16">
    ...
    <nav id="sidebar" class="col-md-2 col-lg-2 d-md-block bg-white sidebar collapse">
        <div class="position-sticky">
            <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link inner-link " aria-current="page" href="#">
                ...
                <li class="nav-item">
                  <a class="nav-link inner-link active" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-people" viewBox="0 0 24 24">
                ...
                <li class="nav-item">
                  <a class="nav-link inner-link" href="#">
